...
%BASETOOLS_DIR%\Bootsectimage.exe -g FDBs.com %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bootsect.com -f
@REM @del FDBS.com
%BASETOOLS_DIR%\Genbootsector.exe -o %EFI_BOOT_DISK% -i %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bootsect.com
@echo Done.
copy %BUILD_DIR%\FV\EfiLdr %EFI_BOOT_DISK%
mkdir %EFI_BOOT_DISK%\efi\boot
copy %WORKSPACE%\EdkShellBinPkg\bin\x64\Shell.efi %EFI_BOOT_DISK%\efi\boot\bootx64.efi /y
@goto end
...
@%BASETOOLS_DIR%\Bootsectimage.exe -g UsbBs16.com %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bs16.com -f
@del UsbBs16.com
@%BASETOOLS_DIR%\Genbootsector.exe -o %EFI_BOOT_DISK% -i %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bs16.com
@%BASETOOLS_DIR%\Genbootsector.exe -m -o %EFI_BOOT_DISK% -i %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Mbr.com
...
@%BASETOOLS_DIR%\Bootsectimage.exe -g UsbBs32.com %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bs32.com -f
@del UsbBs32.com
@%BASETOOLS_DIR%\Genbootsector.exe -o %EFI_BOOT_DISK% -i %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Bs32.com
@%BASETOOLS_DIR%\Genbootsector.exe -m -o %EFI_BOOT_DISK% -i %BUILD_DIR%\X64\DuetPkg\BootSector\BootSector\OUTPUT\Mbr.com
